...
async def test_resolver_overwrite():
    ...
    b_old = Belief(subject="USER", predicate="likes", value="Python", confidence=1.0, turn=1, source="user")
    b_new = Belief(subject="USER", predicate="likes", value="Rust", confidence=1.0, turn=2, source="user")
