...
class TestBeliefDefaults:
    ...
    def test_default_embedding_empty_list(self):
        b = Belief(
            subject="U", predicate="p", value="v", confidence=0.5, turn=1, source="user"
        )
        assert b.embedding == []
...
class TestBeliefValidation:
    ...
    def test_confidence_zero_valid(self):
        b = Belief(
            subject="U", predicate="p", value="v", confidence=0.0, turn=1, source="user"
        )
        assert b.confidence == 0.0

    def test_confidence_one_valid(self):
        b = Belief(
            subject="U", predicate="p", value="v", confidence=1.0, turn=1, source="user"
        )
